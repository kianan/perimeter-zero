# QA Report — TICKET-001: Add tank content data (enemy.csv + enemy_scale.csv)

**Method:** static code review

**Verdict:** PASS

**Summary:** Checked public/data/enemy.csv: new row `tank,Tank,Lumbering bruiser that shrugs off damage,melee,enemies/tank,,0.20` has all 7 columns matching the header, asset='enemies/tank', numeric scale (0.20). Checked public/data/enemy_scale.csv: new row `tank,1,15,50,70` has enemy_id=tank, level=1, numeric damage/health/speed. Health check: tank=50 > rusher=20 and > swarm=10 ✓. Speed check: tank=70 < rusher=110 and < swarm=150 ✓. No other files show tank-related changes; diff is confined to the two CSVs as required. (Tank has no entry in archetypes.ts yet, but that's out of scope for this data-only ticket.)
